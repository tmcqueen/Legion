...
**Goal:** Replace every `int Id` and `int XxxId` foreign key in `Brigade.Admin.Data.Models` with branded `readonly record struct` types backed by UUID v7, regenerate App migrations on both PostgreSQL and SQLite, and update all dependent code (configurations, stores, controllers, Razor pages, tests).

**Architecture:** Each entity gets its own ID type (e.g., `AgentOptionsId`, `SecretOptionsId`) defined in a single `Ids.cs` file in `Brigade.Admin.Data.Models`. Each ID is a `readonly record struct` wrapping a `Guid`, with implicit conversions to/from `Guid` for EF Core compatibility, and a static `New()` factory that calls `Guid.CreateVersion7()`. EF Core value converters are registered per entity in `OnModelCreating`. Auth tables (Identity + OpenIddict) are excluded — they already use string GUIDs.
...
**Created:**
- `src/libs/Brigade.Admin.Data.Models/Ids.cs` — all 11 branded ID types in one file

**Modified (model files):**
- `src/libs/Brigade.Admin.Data.Models/Agents/AgentOptions.cs` — `Id`, `ProviderId`
- `src/libs/Brigade.Admin.Data.Models/Agents/McpServerOptions.cs` — `McpServerOptions.Id`, `McpServerHeaders.Id`, `McpServerHeaders.McpServerId`
- `src/libs/Brigade.Admin.Data.Models/Agents/MemoryOptions.cs` — `Id`, `AgentId`
- `src/libs/Brigade.Admin.Data.Models/Agents/MiddlewareOptions.cs` — `Id`
- `src/libs/Brigade.Admin.Data.Models/Agents/ModelOptions.cs` — `Id`
- `src/libs/Brigade.Admin.Data.Models/Agents/SkillOptions.cs` — `Id`
- `src/libs/Brigade.Admin.Data.Models/Agents/ToolOptions.cs` — `Id`
- `src/libs/Brigade.Admin.Data.Models/Agents/WorkflowOptions.cs` — `Id`
- `src/libs/Brigade.Admin.Data.Models/Providers/ProviderOptions.cs` — `Id`
- `src/libs/Brigade.Admin.Data.Models/SecretOptions.cs` — `Id`

**Modified (configuration files — add value converters):**
- `src/libs/Brigade.Admin.Data/Configurations/AgentOptionsConfiguration.cs`
- `src/libs/Brigade.Admin.Data/Configurations/AgentTemplatesConfiguration.cs`
- `src/libs/Brigade.Admin.Data/Configurations/McpServerOptionsConfiguration.cs`
- `src/libs/Brigade.Admin.Data/Configurations/ProviderOptionsConfiguration.cs`
...
- `src/libs/Brigade.Admin.Data/Configurations/MemoryOptionsConfiguration.cs`
- `src/libs/Brigade.Admin.Data/Configurations/MiddlewareOptionsConfiguration.cs`
- `src/libs/Brigade.Admin.Data/Configurations/ModelOptionsConfiguration.cs`
- `src/libs/Brigade.Admin.Data/Configurations/SkillOptionsConfiguration.cs`
- `src/libs/Brigade.Admin.Data/Configurations/ToolOptionsConfiguration.cs`
- `src/libs/Brigade.Admin.Data/Configurations/WorkflowOptionsConfiguration.cs`
- `src/libs/Brigade.Admin.Data/Configurations/McpServerHeadersConfiguration.cs`

**Modified (stores and interface):**
- `src/libs/Brigade.Admin.Data/Stores/IStore.cs`
- `src/libs/Brigade.Admin.Data/Stores/CatalogStore.cs`
- `src/libs/Brigade.Admin.Data/Stores/AgentStore.cs`
- `src/libs/Brigade.Admin.Data/Stores/McpStore.cs`
- `src/libs/Brigade.Admin.Data/Stores/MemoryStore.cs`
- `src/libs/Brigade.Admin.Data/Stores/ProviderStore.cs`
- `src/libs/Brigade.Admin.Data/Stores/SecretsStore.cs` (interface `ISecretsStore`)
- `src/libs/Brigade.Admin.Data.Sqlite/Stores/SqliteSecretsStore.cs`
- `src/libs/Brigade.Admin.Data.PostgreSQL/Stores/PostgreSqlSecretsStore.cs`
...
- `src/libs/Brigade.Admin.UI/_Imports.razor` — add base models namespace for branded ID types
- `src/libs/Brigade.Admin.UI/Pages/Agents/Agents.Create.razor`
- `src/libs/Brigade.Admin.UI/Pages/Agents/Agents.Update.razor`
- `src/libs/Brigade.Admin.UI/Pages/Agents/Agents.Delete.razor`
- `src/libs/Brigade.Admin.UI/Pages/Mcps/Mcps.Create.razor`
- `src/libs/Brigade.Admin.UI/Pages/Mcps/Mcps.Update.razor`
- `src/libs/Brigade.Admin.UI/Pages/Mcps/Mcps.Delete.razor`
- `src/libs/Brigade.Admin.UI/Pages/Memory/Memory.Update.razor`
- `src/libs/Brigade.Admin.UI/Pages/Memory/Memory.Delete.razor`
- `src/libs/Brigade.Admin.UI/Pages/Middleware/Middleware.Create.razor`
- `src/libs/Brigade.Admin.UI/Pages/Middleware/Middleware.Update.razor`
- `src/libs/Brigade.Admin.UI/Pages/Middleware/Middleware.Delete.razor`
- `src/libs/Brigade.Admin.UI/Pages/Models/Models.Create.razor`
- `src/libs/Brigade.Admin.UI/Pages/Models/Models.Update.razor`
- `src/libs/Brigade.Admin.UI/Pages/Models/Models.Delete.razor`
- `src/libs/Brigade.Admin.UI/Pages/Providers/Providers.Create.razor`
- `src/libs/Brigade.Admin.UI/Pages/Providers/Providers.Update.razor`
- `src/libs/Brigade.Admin.UI/Pages/Providers/Providers.Delete.razor`
- `src/libs/Brigade.Admin.UI/Pages/Skills/Skills.Create.razor`
- `src/libs/Brigade.Admin.UI/Pages/Skills/Skills.Update.razor`
- `src/libs/Brigade.Admin.UI/Pages/Skills/Skills.Delete.razor`
- `src/libs/Brigade.Admin.UI/Pages/Tools/Tools.Create.razor`
- `src/libs/Brigade.Admin.UI/Pages/Tools/Tools.Update.razor`
- `src/libs/Brigade.Admin.UI/Pages/Tools/Tools.Delete.razor`
- `src/libs/Brigade.Admin.UI/Pages/Workflows/Workflows.Create.razor`
- `src/libs/Brigade.Admin.UI/Pages/Workflows/Workflows.Update.razor`
- `src/libs/Brigade.Admin.UI/Pages/Workflows/Workflows.Delete.razor`
- `src/WebDev/Components/Pages/Secrets.razor` (uses `.Id` from `SecretOptions`)

**Modified (Razor components):**
- `src/libs/Brigade.Admin.UI/Components/MemoryEditDialog.razor` — `AgentId`, `MemoryOptions.Id`, `MemoryOptions.AgentId`

**Modified (seed and tests):**
- `src/libs/Brigade.Admin.Data/Seeds/SeedData.Agents.cs`
- `tests/Brigade.Secrets.Tests/SqliteSecretsStoreTests.cs`
- `tests/Brigade.Secrets.Tests/SecretsManagerTests.cs`
...
- `src/libs/Brigade.Admin.Data.PostgreSQL/Migrations/App/*.cs`
- `src/libs/Brigade.Admin.Data.Sqlite/Migrations/App/*.cs`
...
Run: `dotnet build /home/timm/Brigade/Brigade.sln`
Expected: Build succeeds with no errors. Note any pre-existing warnings.

- [ ] **Step 2: Verify existing tests pass**

Run: `dotnet test /home/timm/Brigade/tests/Brigade.Secrets.Tests/Brigade.Secrets.Tests.csproj`
...
**Files:**
- Create: `src/libs/Brigade.Admin.Data.Models/Ids.cs`

- [ ] **Step 1: Write the file with all 11 branded ID types**

Create `src/libs/Brigade.Admin.Data.Models/Ids.cs` with this content:
...
Run: `dotnet build /home/timm/Brigade/src/libs/Brigade.Admin.Data.Models/Brigade.Admin.Data.Models.csproj`
Expected: Build succeeds.

- [ ] **Step 3: Commit**

```bash
cd /home/timm/Brigade
git add src/libs/Brigade.Admin.Data.Models/Ids.cs
...
**Files:**
- Modify: `src/libs/Brigade.Admin.Data.Models/SecretOptions.cs`
...
**Files:**
- Modify: `src/libs/Brigade.Admin.Data.Models/Providers/ProviderOptions.cs`
- Modify: `src/libs/Brigade.Admin.Data.Models/Agents/ModelOptions.cs`
- Modify: `src/libs/Brigade.Admin.Data.Models/Agents/SkillOptions.cs`
- Modify: `src/libs/Brigade.Admin.Data.Models/Agents/ToolOptions.cs`
- Modify: `src/libs/Brigade.Admin.Data.Models/Agents/WorkflowOptions.cs`
- Modify: `src/libs/Brigade.Admin.Data.Models/Agents/MiddlewareOptions.cs`
...
```bash
cd /home/timm/Brigade
git add src/libs/Brigade.Admin.Data.Models/Providers/ProviderOptions.cs \
        src/libs/Brigade.Admin.Data.Models/Agents/ModelOptions.cs \
        src/libs/Brigade.Admin.Data.Models/Agents/SkillOptions.cs \
        src/libs/Brigade.Admin.Data.Models/Agents/ToolOptions.cs \
        src/libs/Brigade.Admin.Data.Models/Agents/WorkflowOptions.cs \
        src/libs/Brigade.Admin.Data.Models/Agents/MiddlewareOptions.cs
...
**Files:**
- Modify: `src/libs/Brigade.Admin.Data.Models/Agents/AgentOptions.cs`
- Modify: `src/libs/Brigade.Admin.Data.Models/Agents/MemoryOptions.cs`
- Modify: `src/libs/Brigade.Admin.Data.Models/Agents/McpServerOptions.cs`
...
```bash
cd /home/timm/Brigade
git add src/libs/Brigade.Admin.Data.Models/Agents/AgentOptions.cs \
        src/libs/Brigade.Admin.Data.Models/Agents/MemoryOptions.cs \
        src/libs/Brigade.Admin.Data.Models/Agents/McpServerOptions.cs
...
**Files:**
- Modify: `src/libs/Brigade.Admin.Data/Configurations/SecretOptionsConfiguration.cs`
- Modify: `src/libs/Brigade.Admin.Data/Configurations/AgentOptionsConfiguration.cs`
- Modify: `src/libs/Brigade.Admin.Data/Configurations/AgentTemplatesConfiguration.cs`
- Modify: `src/libs/Brigade.Admin.Data/Configurations/McpServerOptionsConfiguration.cs`
- Modify: `src/libs/Brigade.Admin.Data/Configurations/ProviderOptionsConfiguration.cs`
...
- [ ] **Step 6: Build the Brigade.Admin.Data project**

Run: `dotnet build /home/timm/Brigade/src/libs/Brigade.Admin.Data/Brigade.Admin.Data.csproj`
Expected: Build succeeds.
...
```bash
cd /home/timm/Brigade
git add src/libs/Brigade.Admin.Data/Configurations/SecretOptionsConfiguration.cs \
        src/libs/Brigade.Admin.Data/Configurations/AgentOptionsConfiguration.cs \
        src/libs/Brigade.Admin.Data/Configurations/AgentTemplatesConfiguration.cs \
        src/libs/Brigade.Admin.Data/Configurations/McpServerOptionsConfiguration.cs \
        src/libs/Brigade.Admin.Data/Configurations/ProviderOptionsConfiguration.cs
...
**Files:**
- Create: `src/libs/Brigade.Admin.Data/Configurations/MemoryOptionsConfiguration.cs`
- Create: `src/libs/Brigade.Admin.Data/Configurations/MiddlewareOptionsConfiguration.cs`
- Create: `src/libs/Brigade.Admin.Data/Configurations/ModelOptionsConfiguration.cs`
- Create: `src/libs/Brigade.Admin.Data/Configurations/SkillOptionsConfiguration.cs`
- Create: `src/libs/Brigade.Admin.Data/Configurations/ToolOptionsConfiguration.cs`
- Create: `src/libs/Brigade.Admin.Data/Configurations/WorkflowOptionsConfiguration.cs`
- Create: `src/libs/Brigade.Admin.Data/Configurations/McpServerHeadersConfiguration.cs`
...
- [ ] **Step 8: Build the Brigade.Admin.Data project**
...
```bash
cd /home/timm/Brigade
git add src/libs/Brigade.Admin.Data/Configurations/MemoryOptionsConfiguration.cs \
        src/libs/Brigade.Admin.Data/Configurations/MiddlewareOptionsConfiguration.cs \
        src/libs/Brigade.Admin.Data/Configurations/ModelOptionsConfiguration.cs \
        src/libs/Brigade.Admin.Data/Configurations/SkillOptionsConfiguration.cs \
        src/libs/Brigade.Admin.Data/Configurations/ToolOptionsConfiguration.cs \
...
**Files:**
- Modify: `src/libs/Brigade.Admin.Data/Stores/IStore.cs`
- Modify: `src/libs/Brigade.Admin.Data/Stores/CatalogStore.cs`
...
```bash
cd /home/timm/Brigade
git add src/libs/Brigade.Admin.Data/Stores/IStore.cs \
        src/libs/Brigade.Admin.Data/Stores/CatalogStore.cs
...
**Files:**
- Modify: `src/libs/Brigade.Admin.Data/Stores/McpStore.cs`
- Modify: `src/libs/Brigade.Admin.Data/Stores/ProviderStore.cs`
- Modify: `src/libs/Brigade.Admin.Data/Stores/ToolStore.cs`
- Modify: `src/libs/Brigade.Admin.Data/Stores/SkillStore.cs`
- Modify: `src/libs/Brigade.Admin.Data/Stores/ModelStore.cs`
- Modify: `src/libs/Brigade.Admin.Data/Stores/WorkflowStore.cs`
- Modify: `src/libs/Brigade.Admin.Data/Stores/MiddlewareStore.cs`
...
```bash
cd /home/timm/Brigade
git add src/libs/Brigade.Admin.Data/Stores/McpStore.cs \
        src/libs/Brigade.Admin.Data/Stores/ProviderStore.cs \
        src/libs/Brigade.Admin.Data/Stores/ToolStore.cs \
        src/libs/Brigade.Admin.Data/Stores/SkillStore.cs \
        src/libs/Brigade.Admin.Data/Stores/ModelStore.cs \
        src/libs/Brigade.Admin.Data/Stores/WorkflowStore.cs \
        src/libs/Brigade.Admin.Data/Stores/MiddlewareStore.cs
...
**Files:**
- Modify: `src/libs/Brigade.Admin.Data/Stores/AgentStore.cs`
- Modify: `src/libs/Brigade.Admin.Data/Stores/MemoryStore.cs`
...
```bash
cd /home/timm/Brigade
git add src/libs/Brigade.Admin.Data/Stores/AgentStore.cs \
        src/libs/Brigade.Admin.Data/Stores/MemoryStore.cs
...
**Files:**
- Modify: `src/libs/Brigade.Admin.Data/Stores/SecretsStore.cs` (interface only)
- Modify: `src/libs/Brigade.Admin.Data/Services/SecretsManager.cs`
...
**Files:**
- Modify: `src/libs/Brigade.Admin.Data.Sqlite/Stores/SqliteSecretsStore.cs`
- Modify: `src/libs/Brigade.Admin.Data.PostgreSQL/Stores/PostgreSqlSecretsStore.cs`
...
Run:
```bash
dotnet build /home/timm/Brigade/src/libs/Brigade.Admin.Data/Brigade.Admin.Data.csproj
dotnet build /home/timm/Brigade/src/libs/Brigade.Admin.Data.Sqlite/Brigade.Admin.Data.Sqlite.csproj
dotnet build /home/timm/Brigade/src/libs/Brigade.Admin.Data.PostgreSQL/Brigade.Admin.Data.PostgreSQL.csproj
```
Expected: `Brigade.Admin.Data` builds. The provider projects may fail because existing migration files still reference integer keys; this is expected and fixed by deleting/regenerating App migrations in Tasks 15-16.
...
- Modify: `src/libs/Brigade.Admin.UI/_Imports.razor`
- Modify: 18 Razor pages with `[Parameter] public int Id`
- Modify: 8 create pages that must assign UUID v7 IDs explicitly
- Modify: `src/libs/Brigade.Admin.UI/Components/MemoryEditDialog.razor`
...
1. `src/libs/Brigade.Admin.UI/Pages/Agents/Agents.Update.razor`
2. `src/libs/Brigade.Admin.UI/Pages/Agents/Agents.Delete.razor`
3. `src/libs/Brigade.Admin.UI/Pages/Mcps/Mcps.Update.razor`
4. `src/libs/Brigade.Admin.UI/Pages/Mcps/Mcps.Delete.razor`
5. `src/libs/Brigade.Admin.UI/Pages/Memory/Memory.Update.razor`
6. `src/libs/Brigade.Admin.UI/Pages/Memory/Memory.Delete.razor`
7. `src/libs/Brigade.Admin.UI/Pages/Middleware/Middleware.Update.razor`
8. `src/libs/Brigade.Admin.UI/Pages/Middleware/Middleware.Delete.razor`
9. `src/libs/Brigade.Admin.UI/Pages/Models/Models.Update.razor`
10. `src/libs/Brigade.Admin.UI/Pages/Models/Models.Delete.razor`
11. `src/libs/Brigade.Admin.UI/Pages/Providers/Providers.Update.razor`
12. `src/libs/Brigade.Admin.UI/Pages/Providers/Providers.Delete.razor`
13. `src/libs/Brigade.Admin.UI/Pages/Skills/Skills.Update.razor`
14. `src/libs/Brigade.Admin.UI/Pages/Skills/Skills.Delete.razor`
15. `src/libs/Brigade.Admin.UI/Pages/Tools/Tools.Update.razor`
16. `src/libs/Brigade.Admin.UI/Pages/Tools/Tools.Delete.razor`
17. `src/libs/Brigade.Admin.UI/Pages/Workflows/Workflows.Update.razor`
18. `src/libs/Brigade.Admin.UI/Pages/Workflows/Workflows.Delete.razor`
...
In `src/libs/Brigade.Admin.UI/_Imports.razor`, add this line with the other `Brigade.Admin.Data.Models` imports:
...
In `src/libs/Brigade.Admin.UI/Pages/Agents/Agents.Create.razor`:
...
In `src/libs/Brigade.Admin.UI/Pages/Agents/Agents.Update.razor`, make the same selected ID field and `FormModel.ProviderId` type replacements. Then replace these assignments:
...
In `src/libs/Brigade.Admin.UI/Pages/Providers/Providers.Create.razor` and `src/libs/Brigade.Admin.UI/Pages/Providers/Providers.Update.razor`, replace:
...
`src/libs/Brigade.Admin.UI/Pages/Models/Models.Create.razor`: add `Id = ModelOptionsId.New(),` as the first property in the existing `new ModelOptions` initializer. Keep every existing model metadata property unchanged.

`src/libs/Brigade.Admin.UI/Pages/Mcps/Mcps.Create.razor`: replace the object initializer:
...
In `src/libs/Brigade.Admin.UI/Pages/Mcps/Mcps.Update.razor`, replace the `ReplaceHeadersAsync` call with:
...
In `src/libs/Brigade.Admin.UI/Components/MemoryEditDialog.razor`, replace:
...
Run: `dotnet build /home/timm/Brigade/src/libs/Brigade.Admin.UI/Brigade.Admin.UI.csproj`
Expected: Build succeeds.
...
git add src/WebDev/Controllers/SecretsController.cs \
        src/libs/Brigade.Admin.UI/_Imports.razor \
        src/libs/Brigade.Admin.UI/Pages/ \
        src/libs/Brigade.Admin.UI/Components/MemoryEditDialog.razor
...
**Files:**
- Modify: `src/libs/Brigade.Admin.Data/Seeds/SeedData.Agents.cs`
...
```bash
cd /home/timm/Brigade
git add src/libs/Brigade.Admin.Data/Seeds/SeedData.Agents.cs
...
**Files:**
- Delete: `src/libs/Brigade.Admin.Data.PostgreSQL/Migrations/App/*.cs`
- Delete: `src/libs/Brigade.Admin.Data.Sqlite/Migrations/App/*.cs`
...
Run:
```bash
rm /home/timm/Brigade/src/libs/Brigade.Admin.Data.PostgreSQL/Migrations/App/20260427121325_InitialCreate.Designer.cs
rm /home/timm/Brigade/src/libs/Brigade.Admin.Data.PostgreSQL/Migrations/App/20260427121325_InitialCreate.cs
rm /home/timm/Brigade/src/libs/Brigade.Admin.Data.PostgreSQL/Migrations/App/20260428101441_AddSecrets.Designer.cs
rm /home/timm/Brigade/src/libs/Brigade.Admin.Data.PostgreSQL/Migrations/App/20260428101441_AddSecrets.cs
rm /home/timm/Brigade/src/libs/Brigade.Admin.Data.PostgreSQL/Migrations/App/AppDbContextModelSnapshot.cs
```
...
Run:
```bash
rm /home/timm/Brigade/src/libs/Brigade.Admin.Data.Sqlite/Migrations/App/20260427122158_InitialCreate.Designer.cs
rm /home/timm/Brigade/src/libs/Brigade.Admin.Data.Sqlite/Migrations/App/20260427122158_InitialCreate.cs
rm /home/timm/Brigade/src/libs/Brigade.Admin.Data.Sqlite/Migrations/App/AppDbContextModelSnapshot.cs
rm /home/timm/Brigade/src/libs/Brigade.Admin.Data.Sqlite/Migrations/20260428101256_AddSecrets.Designer.cs
rm /home/timm/Brigade/src/libs/Brigade.Admin.Data.Sqlite/Migrations/20260428101256_AddSecrets.cs
```
...
Run: `find /home/timm/Brigade/src/libs/Brigade.Admin.Data.PostgreSQL/Migrations/Auth /home/timm/Brigade/src/libs/Brigade.Admin.Data.Sqlite/Migrations/Auth -name "*.cs" 2>/dev/null`
...
```bash
cd /home/timm/Brigade
git add -A src/libs/Brigade.Admin.Data.PostgreSQL/Migrations/ \
          src/libs/Brigade.Admin.Data.Sqlite/Migrations/
...
**Files:**
- Regenerated: `src/libs/Brigade.Admin.Data.PostgreSQL/Migrations/App/<timestamp>_InitialCreate.cs`
- Regenerated: `src/libs/Brigade.Admin.Data.Sqlite/Migrations/App/<timestamp>_InitialCreate.cs`
...
dotnet ef migrations add InitialCreate \
  --project src/libs/Brigade.Admin.Data.PostgreSQL/Brigade.Admin.Data.PostgreSQL.csproj \
  --startup-project src/libs/Brigade.Admin.Data.PostgreSQL/Brigade.Admin.Data.PostgreSQL.csproj \
  --context AppDbContext \
  --output-dir Migrations/App
```
Expected: New migration file created in `src/libs/Brigade.Admin.Data.PostgreSQL/Migrations/App/`.

If this fails because `Brigade.Admin.Data.PostgreSQL` lacks a startup, use the design-time factory at `src/libs/Brigade.Admin.Data.PostgreSQL/AppDbDesignTimeFactory.cs` (already exists per repo inspection).
...
cd /home/timm/Brigade
dotnet ef migrations add InitialCreate \
  --project src/libs/Brigade.Admin.Data.Sqlite/Brigade.Admin.Data.Sqlite.csproj \
  --startup-project src/libs/Brigade.Admin.Data.Sqlite/Brigade.Admin.Data.Sqlite.csproj \
  --context AppDbContext \
  --output-dir Migrations/App
```
Expected: New migration file created in `src/libs/Brigade.Admin.Data.Sqlite/Migrations/App/`.

- [ ] **Step 4: Inspect generated migrations**

Run: `find /home/timm/Brigade/src/libs/Brigade.Admin.Data.PostgreSQL/Migrations/App /home/timm/Brigade/src/libs/Brigade.Admin.Data.Sqlite/Migrations/App -name "*InitialCreate.cs" -exec grep -l "uuid\|TEXT" {} \;`
...
```bash
cd /home/timm/Brigade
git add src/libs/Brigade.Admin.Data.PostgreSQL/Migrations/App/ \
        src/libs/Brigade.Admin.Data.Sqlite/Migrations/App/
...
**Files:**
- Modify: `tests/Brigade.Secrets.Tests/SqliteSecretsStoreTests.cs`
- Modify: `tests/Brigade.Secrets.Tests/SecretsManagerTests.cs`
- Modify: `tests/Brigade.Secrets.Tests/SecretResolvingHandlerTests.cs`
- Modify: `tests/Brigade.Secrets.Tests/SecretsControllerTests.cs`

- [ ] **Step 1: Read existing test files to identify int IDs**

Run: `rg -n "Arg\.Any<int>|It\.IsAny<int>|\bint\s+\w*id\b|Id\s*=\s*[0-9]+|DecryptAsync\(|UpdateValueAsync\(|UpdateDescriptionAsync\(|DeleteAsync\(" /home/timm/Brigade/tests/Brigade.Secrets.Tests`
...
```bash
cd /home/timm/Brigade
git add tests/Brigade.Secrets.Tests/
...
**Files:**
- Create: `tests/Brigade.Secrets.Tests/BrandedIdRoundTripTests.cs`
...
Run: `dotnet test /home/timm/Brigade/tests/Brigade.Secrets.Tests/Brigade.Secrets.Tests.csproj --filter FullyQualifiedName~BrandedIdRoundTripTests`
...
```bash
cd /home/timm/Brigade
git add tests/Brigade.Secrets.Tests/BrandedIdRoundTripTests.cs
...
Run: `find /home/timm/Brigade -maxdepth 3 -name "*.db" -not -path "*/obj/*" -not -path "*/bin/*"`
...
Run: `dotnet build /home/timm/Brigade/src/WebDev/WebDev.csproj`
...
```bash
cd /home/timm/Brigade/src/WebDev
...
```bash
sqlite3 /home/timm/Brigade/src/WebDev/agent.db ".schema Secrets" 2>/dev/null
```
...
Run: `dotnet build /home/timm/Brigade/Brigade.sln 2>&1 | tail -10`
Expected: `Build succeeded` with no errors.

- [ ] **Step 2: Confirm all tests pass**

Run: `dotnet test /home/timm/Brigade/tests/Brigade.Secrets.Tests/Brigade.Secrets.Tests.csproj 2>&1 | tail -5`
...
Run:
```bash
grep -rnE "int Id\b|public int.*Id\b|IEnumerable<int>.*Id|List<int>.*Id|int\? ProviderId|Arg\.Any<int>|It\.IsAny<int>" /home/timm/Brigade/src /home/timm/Brigade/tests \
...
Run: `git log --oneline -- src/libs/Brigade.Admin.Data.PostgreSQL/Migrations/Auth/ src/libs/Brigade.Admin.Data.Sqlite/Migrations/Auth/`
